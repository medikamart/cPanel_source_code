<div class="clearfix"></div>
  ...
  <div style="background: #F3FCFB!important;padding-top: 30px;" class="content-wrapper">



   <div class="container-fluid" style="padding:10%;text-align: center;color: white;">

      <p><strong>IT’S TIME TO TRY IT</strong></p>

      <h1><strong>Ready to use Medikamart ? Choose a plan.</strong></h1>

      <form id="payForm" method="POST" action="<?php echo base_url(); ?>Subscription/PaymentNow">

         <input type="hidden" id="plan_id" value="PLAN_1001" name="plan_id">
                  ...
                  <div class="card-body">
                     ...
                     <ul>
                        ...
                        <li>
                           ...
                           <a href="#"  class="button-3 w-button not-effected" style="font-size: 26px;background: #3f764d;color: white;">Free Plan</a></li>
                  ...
                  <div class="card-body">
                     ...
                     <ul>
                        ...
                        <li>
                           ...
                           <a href="#" onclick="payNow()" class="button-3 w-button not-effected" style="font-size: 26px;background: orange;color: white;">Upgrade Now</a></li>
...
<script type="text/javascript">
...

   {
...

      {
         ...
         $('#price_lbl').html('<h5 ><strong>₹<span style="font-size: 35px;">299</span><strong><sub><span style="font-size:25px;">/</span>month</sub></strong></strong><sub style="font-size:15px;">(exclusive tax)</sub></h5><p style="font-size: 16px;">billed monthly</p>');

         $('#plan_id').val("PLAN_1001");
