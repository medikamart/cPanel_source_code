...
<head>
  ...
  <title><?php echo $this->business_name; ?> | Medikamart</title>
...
<body>
    ...
    if(($this->business_kyc ==0 ) || ($this->user_kyc==0))

    {

        ?>

        <div style="width:100%;height: 25px;background: #c49999;position: relative ;top: 0px; left: 0px;right: 0px;text-align: center;padding-top: 5px;font-size: 11px!important;color: #38837ff0;float: left;">
            ...
            <p>
...

                {
                    ...
                    User Kyc Pending <a href="<?php echo base_url(); ?>Kyc/userkyc">Click Here</a> <span style="color:yellow;">|</span>
...

                {
                    ...
                    ?>
                     ...
                     Business Kyc Pending <a href="<?php echo base_url(); ?>BusinessKyc/business">Click Here</a> 
