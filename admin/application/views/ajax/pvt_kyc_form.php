...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            <input type="text" placeholder="Primary Director Aadhar" class="form-control" name="primary_director_aadhar" id="primary_director_aadhar">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <input type="text" placeholder="Primary Director PAN" class="form-control" name="primary_director_pan" id="primary_director_pan">
        </div>
    </div>
</div>
...
<div class="row">
  <div class="col-md-4">
    <div class="form-group">
      <label>Primary Director Aadhar <span style="color: red;">* PDF</span></label>
      <input type="file" onchange="imageTobase64('primary_director_aadhar_document')" name="primary_director_aadhar_document" accept="application/pdf" id="primary_director_aadhar_document" >
      <input type="hidden"  name="hdn_primary_director_aadhar_document" id="hdn_primary_director_aadhar_document">
      <span><i title="Primary Director Aadhar" class="zmdi zmdi-help-outline"></i></span>
    </div>
  </div>
  <div class="col-md-4">
    <div class="form-group">
      <label>Primary Director PAN <span style="color: red;">* PDF</span></label>
      <input type="file" accept="application/pdf" onchange="imageTobase64('primary_director_pan_document')" name="primary_director_pan_document" id="primary_director_pan_document" >
      <input type="hidden" name="hdn_primary_director_pan_document" id="hdn_primary_director_pan_document">
      <span><i title="Primary Director PAN" class="zmdi zmdi-help-outline"></i></span>
    </div>
  </div>
</div>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
           <input type="text" placeholder="CIN No." name="cin_no" class="form-control" id="cin_no">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
          <label>Board Resolution Upload <span style="color: red;">* PDF</span></label>
           <input onchange="imageTobase64('br_document')" placeholder="Board Resolution Upload" accept="application/pdf" title="Board Resolution Upload" type="file" name="br_document" id="br_document">
           <input type="hidden" name="hdn_br_document" id="hdn_br_document">
          <span><i title="Board Resolution Upload" class="zmdi zmdi-help-outline"></i></span>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
          <label>Certificate Of Incorporation <span style="color: red;">* PDF</span></label>
           <input onchange="imageTobase64('certificate_of_incorporation')" placeholder="Certificate Of Incorporation" accept="application/pdf" title="Certificate Of Incorporation" type="file" name="certificate_of_incorporation" id="certificate_of_incorporation">
           <input type="hidden" name="hdn_certificate_of_incorporation" id="hdn_certificate_of_incorporation">
          <span><i title="Certificate Of Incorporation" class="zmdi zmdi-help-outline"></i></span>
        </div>
    </div>

    <div class="col-md-4">
        <div class="form-group">
           <input onkeyup="addDirectors(this.value)" placeholder="No. Of Directors" title="No. Of Directors" class="form-control" type="number" name="no_of_dir">
        </div>
    </div>
</div>
<input type="hidden" name="directors_count" id="directors_count">
<div class="row" id="directors_name_area">
</div>
