...
abstract class REST_Controller extends CI_Controller {
    ...
    // Informational
    public $mailhost = 'medikamart.in';
    public $mailuser =  'no-reply@medikamart.in';
    public $mailpassword = 'L(@6R%Eito,H';
    public $mailport = 465;
    public $mailsendfromemail = 'no-reply@medikamart.in';
    public $mailsendfromname = 'Medika Mart';
